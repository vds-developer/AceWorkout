...
class TrainingDayGenerator {
    companion object{
        ...
        public var trainingDays: List<TrainingDay> = GenerateTrainingDay(1)
        public var sets  = GenerateSets(random.nextInt(5))
        public var reps  = GenerateReps(random.nextInt(5))
        public var exercise = GenerateExercise(random.nextInt(5))
